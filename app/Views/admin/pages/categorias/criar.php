...
?>
 ...
 <!-- Conteúdo Principal -->
        <main class="flex-1 md:ml-64 p-6 md:p-8">
            ...
            <div class="bg-white p-6 md:p-8 rounded-xl border border-slate-200/80 max-w-xl mx-auto">
                <form class="space-y-6">
                    <div>
                        <label for="nome_categoria" class="block text-sm font-medium text-slate-700 mb-1">Nome da Categoria</label>
                        <input type="text" name="nome_categoria" id="nome_categoria" class="w-full px-4 py-3 border-slate-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-400" placeholder="Ex: Novidades em IA" oninput="generateSlug(this.value)">
                    </div>

                    <div>
                        <label for="slug_categoria" class="block text-sm font-medium text-slate-700 mb-1">Slug</label>
                        <input type="text" name="slug_categoria" id="slug_categoria" class="w-full px-4 py-3 border-slate-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-400 bg-slate-50" placeholder="Ex: novidades-em-ia" readonly>
                    ...
                    <div>
                        ...
                        <textarea name="descricao_categoria" id="descricao_categoria" rows="4" class="w-full px-4 py-3 border-slate-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-400" placeholder="Uma breve descrição sobre a categoria..."></textarea>
                    </div>

                     <div>
                        <label for="categoria_pai" class="block text-sm font-medium text-slate-700 mb-1">Categoria Pai (Opcional)</label>
                        <select id="categoria_pai" name="categoria_pai" class="w-full px-4 py-3 border-slate-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 bg-white">
