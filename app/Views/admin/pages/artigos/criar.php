                ...
                <div class="lg:col-span-2 bg-white p-6 md:p-8 rounded-xl border border-slate-200/80">
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="titulo" id="titulo" class="w-full px-4 py-3 border-slate-300 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-400" placeholder="Ex: As Novas Tendências de Design para 2024">
                        </div>

                        <div>
                            <label for="conteudo" class="block text-sm font-medium text-slate-700 mb-1">Conteúdo</label>
                            <textarea name="conteudo" id="conteudo" rows="12" class="w-full px-4 py-3 border-slate-300 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-400" placeholder="Escreva o conteúdo do seu artigo aqui..."></textarea>
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-white p-6 rounded-xl border border-slate-200/80">
                        ...
                        <div>
                            ...
                            <select id="status" name="status" class="w-full px-4 py-3 border-slate-300 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="datetime-local" name="data_publicacao" id="data_publicacao" class="w-full px-4 py-3 border-slate-300 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    ...
                    <div class="bg-white p-6 rounded-xl border border-slate-200/80">
                        ...
                        <div>
                            ...
                            <select id="categoria" name="categoria" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" name="tags" id="tags" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-400" placeholder="Ex: ia, frontend, ux (separadas por vírgula)">
                        </div>
                    </div>
