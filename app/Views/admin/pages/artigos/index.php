 ...
 <!-- Conteúdo Principal -->
        <main class="flex-1 md:ml-64 p-6 md:p-8">
            ...
            <header class="mb-8 bg-white py-6 px-5 rounded-lg shadow-sm flex justify-between items-center">
                ...
                <a href="/projeto/admin/artigos/criar" class="bg-slate-700 hover:bg-slate-600 text-white font-semibold py-2.5 px-5 rounded-lg text-sm flex items-center space-x-2 transition-colors">
